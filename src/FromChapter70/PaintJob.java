...
public class PaintJob {
    /*
    Paint Job
Bob is a wall painter and he needs your help. You have to write a program that helps Bob calculate how
many buckets of paint he needs to buy before going to work. Bob might also have some extra buckets at home.
...
The fourth parameter should be named extraBuckets. This parameter represents the bucket count that Bob has
 at home.
...
NOTE: Do not add the main method to the solution code.
    ...
    public static int  getBucketCount(double width, double height, double areaPerBucket, int extraBuckets)
    {
        ...
        if(width<=0 || height<=0 || areaPerBucket<=0 || extraBuckets<0)
        {
            ...
            bucketNeeds = (int) Math.round(area/areaPerBucket-extraBuckets);
        }
        return bucketNeeds;
    }
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket)
    {
        ...
        if(width<=0 || height<=0 || areaPerBucket<=0)
        {
            ...
            double area =width*height;
            bucketNeeds = (int) Math.ceil(area/areaPerBucket);
        }
        return bucketNeeds;
    }
